...
WHO guidance on AI for health identifies ethical and governance concerns such as autonomy, transparency, accountability, bias, privacy, and safety (WHO, 2021, 2024a). Generative models may produce inconsistent output and may not clearly communicate uncertainty.
